  ...
  return (
    <div className="px-5 rounded-lg">
      ...
      <Button
        ...
        className="hidden md:flex w-full text-white text-base bg-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-800 rounded-xl items-center justify-center gap-2"
